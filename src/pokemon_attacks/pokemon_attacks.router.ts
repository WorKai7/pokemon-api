...
import { createPokemonAttack, deletePokemonAttack, getPokemonAttack, getPokemonAttacks, updatePokemonAttack } from './pokemon_attacks.controller';
...
pokemonAttacksRouter.delete('/:pokemonAttackId', verifyJWT, deletePokemonAttack);