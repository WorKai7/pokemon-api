...
describe('PokemonCard API', () => {
    ...
    describe('POST /pokemon-cards', () => {
        ...
        it('should return an error (name or pokedexId already exist)', async () => {
            ...
            prismaMock.pokemonCard.findFirst.mockResolvedValue(
                createdPokemonCard,
            );
            ...
            expect(response.status).toBe(400);
            expect(response.body).toEqual({
                error: 'name or pokedexId already exist',
            });
        });
        ...
        it('should return an error (weakness type not found)', async () => {
            ...
            prismaMock.type.findUnique.mockResolvedValueOnce({
                id: 6,
                name: 'Ice',
            });
            prismaMock.pokemonAttack.findUnique.mockResolvedValue({
